...
게임 그래픽 디자이너용 이미지 프롬프트 생성기. GPT Image / Nano Banana / Midjourney / Niji **12종 모델** + **16종 스타일**. 라이트/다크 모드. Niji 전용 7항목 입력.
...
- 입력: 작업유형 5 / 스타일 16 / 비율 5+직접 / 참고이미지 클릭+드래그앤드롭 / 역할 5 / 금지 6 / 한글 textarea / 영어 textarea / **Niji 전용 7항목**
